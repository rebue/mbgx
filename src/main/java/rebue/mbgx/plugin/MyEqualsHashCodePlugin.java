/**
 * XXX MBG : MyEqualsHashCodePlugin : 为Model类自动生成equals和hashCode方法
 * 重写了原生的插件，复制的是1.4.0版本的源码
 ...
 *
 * <p>
 * The <code>equals</code> method generated by this class is correct in most cases,
 ...
 *
 * <p>
 * Similarly, the <code>hashCode</code> method generated by this class only relies
...
public class MyEqualsHashCodePlugin extends PluginAdapter {
    ...
    protected void generateEquals(final TopLevelClass topLevelClass, final List<IntrospectedColumn> introspectedColumns,
        ...
        while (iter.hasNext()) {
            ...
            // XXX MBG : MyEqualsHashCodePlugin : 如果不是主键则则忽略
            if (!IntrospectedUtils.isPrimaryKey(introspectedColumn, introspectedTable)) {
                continue;
            }
            ...
            final String getterMethod = getGetterMethodName(introspectedColumn.getJavaProperty(),
...
//            }
    ...
    protected void generateHashCode(final TopLevelClass topLevelClass,
        ...
        while (iter.hasNext()) {
            ...
            // XXX MBG : MyEqualsHashCodePlugin : 如果不是主键则忽略
            if (!IntrospectedUtils.isPrimaryKey(introspectedColumn, introspectedTable)) {
                continue;
            }
            ...
            final String getterMethod = getGetterMethodName(introspectedColumn.getJavaProperty(), fqjt);
